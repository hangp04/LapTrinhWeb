<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($form_valid) {
            ...
            setcookie('invoiceID', $invoiceID, time() + 20, "/");
            setcookie('payfor', json_encode($payfor), time() + 20, "/");
            setcookie('fileToUpLoad', $fileToUpLoad, time() + 20, "/");
            setcookie('add_in4', $_POST['add_in4'], time() + 20, "/");

            header("Location: show_cookie_bai2.php");
        }
    }
