...
<body>
    <div class="container">
        ...
        <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST" && empty($firstnameerror) && empty($lastnameerror) && empty($emailerror) && empty($invoiceIDerror) && empty($payforerror) && !empty($fileToUpLoad)){
                ...
                echo '<img src="' . htmlspecialchars($fileToUpLoad) . '" alt="Uploaded Image" style="max-width:100%; height:auto;" />';
                echo '<p><strong>Additional Information:</strong> $add_in4</p>';
            }
        ?>
    </div>
